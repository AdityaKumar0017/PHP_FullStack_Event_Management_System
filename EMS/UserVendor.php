...
$vendors = [
    ...
    ['id' => 3, 'name' => 'Vendor Three', 'description' => 'Specializing in electronics'],
    ['id' => 4, 'name' => 'Vendor Four', 'description' => 'Specializing in electronics'],
    ['id' => 5, 'name' => 'Vendor Five', 'description' => 'Specializing in electronics'],
